...
<body>
	<div class="check">
        <button class="btn active" id="menBtn">Men</button>
        <button class="btn" id="womenBtn">Women</button>
        <button class="btn" id="electornicsBtn">Electoronics</button>
        <button class="btn" id="kidsBtn">Kids</button>
        <button class="btn" id="groceriesBtn">Groceries</button>
    </div>
    <!-- end of the slider -->
    <div id="men">
        ...
        <div class="container active">
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/832/832/xif0q/t-shirt/a/x/e/s-fc4454-4455-fastcolors-original-imagqbv2mcqyyjsc.jpeg?q=70"
                    alt="">
                <p id="name">Mens Tshirt</p>
                <p class="itemP">Min 50% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/832/832/km2clu80/shoe/t/9/a/9-ca40273-9-kraasa-brown-original-imagffy5ycwqxraz.jpeg?q=70"
                    alt="">
                <p id="name">Layasa Boots</p>
                <p class="itemP">Min 30% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/832/832/xif0q/kurta/c/i/r/s-navy-nawab-sopani-original-imagpv6ggchh9ggj.jpeg?q=70"
                    alt="">
                <p id="name">Mens Kurta</p>
                <p class="itemP">Min 40% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/watch/m/r/r/-original-imagvwscapprfwww.jpeg?q=70"
                    alt="">
                <p id="name">Watch</p>
                <p class="itemP">Min 30% off.</p>
            </div>
    ...
    <div id="women">
        ...
        <div class="container">
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/832/832/xif0q/t-shirt/5/z/b/s-ww-melanin-balck-smartees-original-imagnxarrg6ygzhj.jpeg?q=70"
                    alt="">
                <p id="name">Women Tshirts</p>
                <p class="itemP">Min 50% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/832/832/xif0q/bag/q/9/o/travel-makeup-bag-cosmetic-bag-portable-waterproof-soft-pu-original-imagkss4qxsazvmh.jpeg?q=70"
                    alt="">
                <p id="name">Top Brand Bags</p>
                <p class="itemP">Min 30% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/lip-balm/f/1/r/4-5-nourishing-lip-balm-03-vanilla-1-sugar-pop-original-imagjt9tdhv3ftux.jpeg?q=70"
                    alt="">
                <p id="name">Lip Balm</p>
                <p class="itemP">Min 40% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/facial-kit/k/z/a/-original-imagruygwzan4gta.jpeg?q=70"
                    alt="">
                <p id="name">Facial Kit</p>
                <p class="itemP">Min 30% off.</p>
            </div>
        </div>
    </div>
    ...
    <div id="electornics">
        ...
        <div class="container">
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/computer/a/t/8/-original-imagwy8dujphzvng.jpeg?q=70"
                    alt="">
                <p id="name">Laptops</p>
                <p class="itemP">Min 50% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/l3rmzrk0/joystick/p/z/o/x3-wireless-bluetooth-gamepad-for-android-windows-smart-tv-pubg-original-imagetkgqpzfwvn7.jpeg?q=70"
                    alt="">
                <p id="name">Video Game</p>
                <p class="itemP">Min 30% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/kk01pjk0/dslr-camera/f/v/o/eos-1500d-canon-original-imafzfugydh2mjgf.jpeg?q=70"
                    alt="">
                <p id="name">Camera</p>
                <p class="itemP">Min 40% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/pendrive/pendrive/j/m/q/v215w-hp-original-imagr9gzn9rrg7ks.jpeg?q=70"
                    alt="">
                <p id="name">Pendrive</p>
                <p class="itemP">Min 30% off.</p>
            </div>
        </div>
    </div>
    ...
    <div id="kids">
        <div class="container">
            ...
            <div class="container">
                <div id="item">
                    <img id="firstRow"
                        src="https://rukminim2.flixcart.com/image/416/416/l3929ow0/puzzle/y/t/k/1-premium-speed-cube-3x3x3-for-kids-and-adults-multicolor-original-imageexxbc9yzk5p.jpeg?q=70"
                        alt="">
                    <p id="name">Rubic Cube</p>
                    <p class="itemP">Min 50% off.</p>
                </div>
                <div id="item">
                    <img id="firstRow"
                        src="https://rukminim2.flixcart.com/image/416/416/xif0q/remote-control-toy/y/w/r/remote-control-super-high-speed-racing-car-with-stylish-looks-original-imagtzd4ajywcpep.jpeg?q=70"
                        alt="">
                    <p id="name">Remote Control Car</p>
                    <p class="itemP">Min 30% off.</p>
                </div>
                <div id="item">
                    <img id="firstRow"
                        src="https://rukminim2.flixcart.com/image/416/416/kn4xhu80/stuffed-toy/o/h/x/red-3-feet-teddy-bear-very-cute-loveable-huggable-teddy-bear-90-original-imagfvm8ucgagrzk.jpeg?q=70"
                        alt="">
                    <p id="name">Teddy Bear</p>
                    <p class="itemP">Min 40% off.</p>
                </div>
                <div id="item">
                    <img id="firstRow"
                        src="https://rukminim2.flixcart.com/image/416/416/kr2e3680/ball/a/9/0/380-420-22-5-kick-1-101smufb01-football-cosco-original-imag4xhfvcdgn4gz.jpeg?q=70"
                        alt="">
                    <p id="name">Foot Ball</p>
                    <p class="itemP">Min 30% off.</p>
                </div>
            </div>
        </div>
    ...
    <div id="groceries">
        ...
        <div class="container">
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/tea/b/l/e/100-lemon-honey-green-tea-for-weight-loss-with-premium-green-tea-original-imagzr9kdvfh5q7a.jpeg?q=70"
                    alt="">
                <p id="name">Green Tea</p>
                <p class="itemP">Min 50% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/cereal-flake/j/z/b/-original-imagw92uzxh3pam7.jpeg?q=70"
                    alt="">
                <p id="name">Kellogg's Chocos</p>
                <p class="itemP">Min 30% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/xif0q/cake-pastry/7/a/z/-original-imagvqfdtgdumjkz.jpeg?q=70"
                    alt="">
                <p id="name">ChocoBakes</p>
                <p class="itemP">Min 40% off.</p>
            </div>
            <div id="item">
                <img id="firstRow"
                    src="https://rukminim2.flixcart.com/image/416/416/kx7vc7k0/cookie-biscuit/d/u/k/-original-imag9pueznhyzgtb.jpeg?q=70"
                    alt="">
                <p id="name">Choco-Pie</p>
                <p class="itemP">Min 30% off.</p>
            </div>
        </div>
    </div>
